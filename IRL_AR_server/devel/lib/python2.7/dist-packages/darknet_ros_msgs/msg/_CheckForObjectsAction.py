...
class CheckForObjectsAction(genpy.Message):
  _md5sum = "e24409c1da857da141c5ab103c43f6a1"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_result.result.bounding_boxes.count
      buff.write(_get_struct_b().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_result.result.bounding_boxes.count,) = _get_struct_b().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
