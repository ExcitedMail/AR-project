...
class BoundingBoxes(genpy.Message):
  _md5sum = "263d694537494fe0f4afe415c0a292ac"
...
string Class
"""
  __slots__ = ['header','image_header','count','bounding_boxes']
  _slot_types = ['std_msgs/Header','std_msgs/Header','int8','darknet_ros_msgs/BoundingBox[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,image_header,count,bounding_boxes
