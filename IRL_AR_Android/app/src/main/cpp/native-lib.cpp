...
Java_com_google_ar_sceneform_samples_promar_PromarMainActivity_CVTest(JNIEnv *env, jobject instance, jlong matAddr, jlong id, jintArray update_ids, jlongArray update_poses_address ) {
